...
import io.kabany.poc_server_spring_java.response.ResponseHelper;
...
public class MetaController {
  ...
  JsonResponse ping() {
    return ResponseHelper.SuccessResponse(null, "pong!");
  }
  ...
  JsonResponse healthCheck() {
    return ResponseHelper.SuccessResponse(null, "ok!");
  }
  ...
  JsonResponse sendVersion() {
    return ResponseHelper.SuccessResponse(null, version);
  }
}
